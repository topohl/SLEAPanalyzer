...
| # | Defect |
|---|--------|
| P3-1 PARTIAL | Machine-specific `S:/` and `C:/Users/...` paths in every production script. |
| P3-2 FIXED | No configuration files; arena size, thresholds and fps are literals inside loops. |
